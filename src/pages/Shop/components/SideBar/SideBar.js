...
export default function SideBar() {
    ...
    useEffect(() => {
        ...
        totalProductByTypeArr.unshift({name: "All", value: productList.length})
    ...
    const productListBeforeBrandFilter = useSelector(brandListRemainingSelector)
    ...
    const handleCheckedChange = (idValue, brandName) => {
        ...
        } else {BrandArr = checkedBrandArr.filter((item) => item !== brandName)}
